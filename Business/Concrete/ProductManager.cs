...
namespace Business.Concrete
{
    //Validation
    //Business Codes
    //Validation and Business Codes are different things. Validation is about structure of object.
    public class ProductManager : IProductService
    {
        IProductDal _productDal;
        ICategoryService _categoryService; // It is service, not dal. It is used to service in order to be able to use facilities, aspects, (cross cutting concerns) etc...
